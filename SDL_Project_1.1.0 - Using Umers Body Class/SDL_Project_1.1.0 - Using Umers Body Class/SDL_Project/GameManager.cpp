...
bool GameManager::OnCreate() 
{
	...
	uimanage = new UIManager(ptr->GetSDL_Window());
			...
			else
			{
				...
				case SDL_KEYUP:
					...
					case SDLK_F2: //switch to assignment two when f2 key is pressed / or restart assignment 2
						...
						currentScene->OnCreate();//build scene
						break;
					case SDLK_F3: //switch to assignment 3 when f3 key is pressed / or restart assignment 3
						currentScene->OnDestroy(); //delete current scene
						delete currentScene;
						currentScene = nullptr;
						...
						currentScene->OnCreate(); //build scene
						break;
					case SDLK_0:// switches to specified ui in the ui manager when key is pressed
						uimanage->SwitchUI(0);
						break;
					case SDLK_1:
						uimanage->SwitchUI(1);
